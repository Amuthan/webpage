...
Details of my current and previous research can be found here.

## Preprints

- Dharamveer Kumar, AAR,
*A direct approach to computing the non-interacting kinetic energy functional*,
Preprint available on [arxiv](https://arxiv.org/pdf/2507.00321)

- AAR, Prabhu Ramachandran,
*Anisotropic, sparse, and interpretable Physics-Informed Neural Networks for PDEs*, Preprint available on [arxiv](https://arxiv.org/pdf/2207.00377).

- Bhanu Pratap Sharma, AAR, Abhijit Gogulapati,
*A computational study of the interplay between viscoplasticity and hardening for impact-loaded uniform density foams*,
Preprint available on [Engineering Archive](https://engrxiv.org/preprint/view/5050).
...
- *An efficient algorithm for PDE-constrained optimization problems by augmenting the adjoint method with active operator learning*, presented at United States National Congress on Theoretical and Applied Mechanics (USNC-TAM 26), June 21—25, Pasadena, CA.

- *Accelerating finite element solvers for parametric PDEs using low-fidelity neural surrogates*, with Victor Alcantar-Arias (undergraduate student), presetned at Engineering Mechanics Institute Conference (EMI 2026), June 2—5, 2026, University of Colorado, Boulder.

- *Explainable Machine Learning for Partial Differential Equations*, poster presentation at Cal Poly’s inaugural AI Convening, Nov 6, 2026, Cal Poly.


### From research at IIT Bombay
